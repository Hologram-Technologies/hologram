...
//!   ([`Kappa`] = `hologram_space::KappaLabel71`) minted and verified
...
/// portable [`NetworkInterface`](hologram_space::NetworkInterface), so a
...
/// (`hologram_space`) — defined there, consumed here by reference
