...
//! hologram [`Realization`](hologram_space::Realization) embedding the
...
use hologram_space::{Capabilities, Realization, RealizationError, References};
...
impl Realization for Configuration {
    const IRI: hologram_space::RealizationId = Configuration::IRI;
