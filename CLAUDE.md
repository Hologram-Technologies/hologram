...
<!-- ARCHGRAPH:CONTEXT:BEGIN -->
## Ecosystem Context (auto-generated by archgraph)
...
|------|------|--------------------|
| UOR-Framework | library | Root crate providing math primitives and ontology-based trait system |

### Who depends on you

- **hologram-ai** — AI inference extensions for hologram runtime
<!-- ARCHGRAPH:CONTEXT:END -->
