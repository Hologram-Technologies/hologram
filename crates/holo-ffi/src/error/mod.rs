...
/// Store an error message for later retrieval via `holo_error_message`.
...
#[no_mangle]
pub extern "C" fn holo_last_error() -> i32 {
...
#[no_mangle]
pub extern "C" fn holo_error_message() -> *const c_char {
...
mod tests {
    ...
    fn initial_state_no_error() {
        clear_last_error();
        assert_eq!(holo_last_error(), 0);
        assert!(holo_error_message().is_null());
    }
