...
use hologram_fused_component::lut_gemm::orbit::build_orbit_map_q8;
use hologram_fused_component::lut_gemm::quantize::quantize_8bit;
...
fn quantize_uniform_floor_division() {
    use hologram_fused_component::lut_gemm::quantize::quantize_8bit_uniform;
