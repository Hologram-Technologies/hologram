...
use hologram_fused_component::float_dispatch::dispatch_float;
...
fn reshape_neg1_infers_n_heads_not_head_dim() {
    use hologram_fused_component::float_dispatch::dispatch_reshape_with_shape;
...
fn batched_matmul_rejects_k_dim_mismatch() {
    use hologram_fused_component::float_dispatch::dispatch_batched_matmul;
...
fn shape_start_end_extracts_seq_and_head_dim() {
    ...
    use hologram_fused_component::float_dispatch::dispatch_shape_sliced;
