...
impl OpKind {
    ...
    pub const fn primary_primitive(self) -> uor_foundation::PrimitiveOp {
        ...
        match self {
            ...
            K::MatMul | K::Gemm | K::Conv2d | K::ConvTranspose2d
                ...
                | K::FusedMatMulActivation | K::FusedConv2dActivation
                | K::FusedNormActivation | K::FusedUnaryChain => P::Mul,
    ...
    pub const fn primary_grad(self) -> Option<OpKind> {
        ...
        match self {
            ...
            // Fused ops inherit gradient from their primary op.
            K::FusedMatMulActivation => Some(K::MatMulGradA),
            K::FusedConv2dActivation => Some(K::Conv2dGradX),
            K::FusedNormActivation => Some(K::LayerNormGrad),
            K::FusedUnaryChain => Some(K::UnaryGrad),
    ...
    pub const fn cap(self) -> usize {
        ...
        match self {
            ...
            K::Gelu
                ...
                | K::FusedMatMulActivation | K::FusedConv2dActivation
                | K::FusedNormActivation | K::FusedUnaryChain
    ...
    pub const fn primary_arity(self) -> u8 {
        ...
        match self {
            ...
            K::Add | K::Sub | K::Mul | K::Xor | K::And | K::Or
                ...
                | K::FusedSwiGlu | K::FusedMatMulActivation | K::FusedConv2dActivation
                | K::AddRmsNorm
                | K::MatMulGradA | K::MatMulGradB
